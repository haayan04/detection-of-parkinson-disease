...
main = tkinter.Tk()
main.title("Detection of Parkinson's Disease through Analysis of Image and Speech Data")
...
font = ('times', 16, 'bold')
title = Label(main, text="Detection of Parkinson's Disease through Analysis of Image and Speech Data",anchor=W, justify=CENTER)
